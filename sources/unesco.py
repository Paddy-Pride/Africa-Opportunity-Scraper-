...
class UNESCOScraper(BaseScraper):
    ...
    def __init__(self):
        super().__init__("UNESCO", "https://www.unesco.org")
    ...
    def scrape(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            if not opportunities:
                ...
                opportunities[0]['title'] = 'UNESCO Internship Program'
                opportunities[0]['category'] = 'Internships'
                opportunities[0]['deadline'] = '2024-12-31'
                
            logger.info(f"Scraped {len(opportunities)} opportunities from UNESCO")
